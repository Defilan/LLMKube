...
## [0.8.0](https://github.com/Defilan/LLMKube/compare/v0.7.12...v0.8.0) (2026-05-28)


### ⚠ BREAKING CHANGES

* update default CUDA image to server-cuda13 for Qwen3.5 and Blackwell support ([#262](https://github.com/Defilan/LLMKube/issues/262))

### Features

* add --jinja flag for tool/function calling support ([#162](https://github.com/Defilan/LLMKube/issues/162)) ([47624ca](https://github.com/Defilan/LLMKube/commit/47624ca2e060aa0e1accd9950f3b15cd66312f46))
* add --llama-server-port for a fixed llama-server runtime port ([#499](https://github.com/Defilan/LLMKube/issues/499)) ([cc30b0d](https://github.com/Defilan/LLMKube/commit/cc30b0dbd5cc8493547f3a251c11ad02d391aa58))
* add 32B models to catalog with --context flag ([#88](https://github.com/Defilan/LLMKube/issues/88)) ([6c06602](https://github.com/Defilan/LLMKube/commit/6c066026b11c108072fab77c2d7b6ee61b432203))
* add air-gapped deployment support for local model paths ([#85](https://github.com/Defilan/LLMKube/issues/85)) ([31fe8d0](https://github.com/Defilan/LLMKube/commit/31fe8d051fa5be51626dc64c4bc56d05dbfade7a))
* Add benchmark command and reorganize documentation ([58307be](https://github.com/Defilan/LLMKube/commit/58307bece720644bbdf1e27026a90279b9009c51))
* Add benchmark command and reorganize documentation ([ac8888e](https://github.com/Defilan/LLMKube/commit/ac8888ea2ac41f90ebd6b529deea86b2fa67f24f)), closes [#6](https://github.com/Defilan/LLMKube/issues/6)
* add custom CA support and fix deprecated image tags ([#124](https://github.com/Defilan/LLMKube/issues/124)) ([5ec912e](https://github.com/Defilan/LLMKube/commit/5ec912e1c80076cd9a7af0c9e9ad98fe92381a27))
* add first-class PersonaPlex (Moshi) runtime backend ([#272](https://github.com/Defilan/LLMKube/issues/272)) ([2b1c948](https://github.com/Defilan/LLMKube/commit/2b1c948052806108ea2dea3debeea54379dc450b))
* add GPU contention visibility, queue position, and priority classes ([#81](https://github.com/Defilan/LLMKube/issues/81)) ([c0220e5](https://github.com/Defilan/LLMKube/commit/c0220e5a392a5958d826eabdffe68bfce46f84d4))
* add GPU observability config and Grafana dashboard ([#105](https://github.com/Defilan/LLMKube/issues/105)) ([571643f](https://github.com/Defilan/LLMKube/commit/571643fadcc6a106f360b8bd1ceec26360f62058))
* add Grafana inference metrics dashboard ([#269](https://github.com/Defilan/LLMKube/issues/269)) ([be376c6](https://github.com/Defilan/LLMKube/commit/be376c67523cd2565997bd0cae886d19c2bc51ee))
* Add Helm chart for easy installation ([5718804](https://github.com/Defilan/LLMKube/commit/5718804a33905a30393993156c8c0ec4a56d0538))
* Add Helm chart for easy installation with comprehensive CI testing ([3ea3bfd](https://github.com/Defilan/LLMKube/commit/3ea3bfd27ce864f7884f25ae9db65ed52eb68e01)), closes [#9](https://github.com/Defilan/LLMKube/issues/9)
* add HPA autoscaling for InferenceService ([#260](https://github.com/Defilan/LLMKube/issues/260)) ([2d16502](https://github.com/Defilan/LLMKube/commit/2d165023b3595a137104acff382474ee5498c5ba))
* add hybrid GPU/CPU offloading support for MoE models ([#281](https://github.com/Defilan/LLMKube/issues/281)) ([2287f66](https://github.com/Defilan/LLMKube/commit/2287f664a638fc1a3e976ef63b902eb951adefa9))
* add KV cache type configuration and extraArgs escape hatch ([#256](https://github.com/Defilan/LLMKube/issues/256)) ([7a4b855](https://github.com/Defilan/LLMKube/commit/7a4b855d180cabd224b5121eff60298c3bfb24f2))
* add license compliance scanning for GGUF models ([#188](https://github.com/Defilan/LLMKube/issues/188)) ([c26400a](https://github.com/Defilan/LLMKube/commit/c26400a319af79995dc7bd5b20843b9926f0cfb4))
* add make lint-all target for cross-arch linting ([#508](https://github.com/Defilan/LLMKube/issues/508)) ([f57dd5b](https://github.com/Defilan/LLMKube/commit/f57dd5b0f5178a9c5d6e284a7f1bd5e36f1b282d))
* add memory pressure watchdog with runtime monitoring ([#216](https://github.com/Defilan/LLMKube/issues/216)) ([5fa6d54](https://github.com/Defilan/LLMKube/commit/5fa6d54f778e68f9bf4739fb232e05c9a9791971))
* Add Metal GPU support for macOS (Apple Silicon) ([f673c26](https://github.com/Defilan/LLMKube/commit/f673c26bd4ac1a285dc7e72ffe6a930bc586b855)), closes [#33](https://github.com/Defilan/LLMKube/issues/33)
* add mlx-server runtime to the metal-agent ([#471](https://github.com/Defilan/LLMKube/issues/471)) ([8bf9808](https://github.com/Defilan/LLMKube/commit/8bf9808edc03f6d8485b21e390b9ad6fbad092df))
* Add model catalog with 10 pre-configured models ([404d722](https://github.com/Defilan/LLMKube/commit/404d722e70d3e885f1e437ebdadf38fe43c7689a))
* Add model catalog with 10 pre-configured models (Phase 1) ([0fd969a](https://github.com/Defilan/LLMKube/commit/0fd969a8268d47045f18771206036cc5d243ba3e))
* add Ollama as runtime backend for Metal agent ([#258](https://github.com/Defilan/LLMKube/issues/258)) ([6148b89](https://github.com/Defilan/LLMKube/commit/6148b899547966bc18719bf73243af873d9064c4))
* add oMLX as alternative runtime backend for Metal agent ([#257](https://github.com/Defilan/LLMKube/issues/257)) ([eaf9045](https://github.com/Defilan/LLMKube/commit/eaf90451c9f15cdd02f6eafbef12eda81768b955))
* Add persistent model cache to avoid re-downloading ([83f844f](https://github.com/Defilan/LLMKube/commit/83f844f7b8ca18c2eed407b0f6995f2dc13e0965)), closes [#52](https://github.com/Defilan/LLMKube/issues/52)
* add pluggable runtime backends for non-llama.cpp inference engines ([#271](https://github.com/Defilan/LLMKube/issues/271)) ([bb1576c](https://github.com/Defilan/LLMKube/commit/bb1576c04f685b5657aef7b0fb3f2c9a840fcd1a))
* add pod security context defaults and CRD overrides ([#239](https://github.com/Defilan/LLMKube/issues/239)) ([904432b](https://github.com/Defilan/LLMKube/commit/904432b4e4669d9a2efb44de43f2c49c4747d9b5))
* add Prometheus metrics, OpenTelemetry tracing, and inference observability ([#189](https://github.com/Defilan/LLMKube/issues/189)) ([c653ff1](https://github.com/Defilan/LLMKube/commit/c653ff1c2f1dbbe564a56cee22f34efc2d463049))
* add PVC inspection to cache list for orphaned entry detection ([#183](https://github.com/Defilan/LLMKube/issues/183)) ([2723d92](https://github.com/Defilan/LLMKube/commit/2723d92b7030472f8dd0ba57f5dd523356672d94))
* add pvc:// model source and SHA256 integrity verification ([#229](https://github.com/Defilan/LLMKube/issues/229)) ([1b94f5d](https://github.com/Defilan/LLMKube/commit/1b94f5d560dd596315af76a40f377d6b8f34cedf))
* Add Release Please automation and version-agnostic docs ([dc2d54e](https://github.com/Defilan/LLMKube/commit/dc2d54ea15f936a62b6fa1d382c1f606d97a5610))
* add scale sub resource ([#474](https://github.com/Defilan/LLMKube/issues/474)) ([73419a5](https://github.com/Defilan/LLMKube/commit/73419a5efb6a2aee264a5787c1fa056d548e2137))
* add tensor overrides and batch size controls for hybrid offloading ([#283](https://github.com/Defilan/LLMKube/issues/283)) ([8be4adc](https://github.com/Defilan/LLMKube/commit/8be4adc56bfb959049ae84a3da48cc4f8ab7d98e))
* add vLLM and TGI runtime backends with per-runtime HPA metrics ([#273](https://github.com/Defilan/LLMKube/issues/273)) ([441c7c7](https://github.com/Defilan/LLMKube/commit/441c7c77cf72936fd1cf31ea0b44914018579172))
* **agent:** add --host-ip flag for remote K8s cluster support ([#155](https://github.com/Defilan/LLMKube/issues/155)) ([b425569](https://github.com/Defilan/LLMKube/commit/b42556919afe0089e6ebde1d35fe79459e116fcb))
* **agent:** add structured zap logging to metal agent ([#164](https://github.com/Defilan/LLMKube/issues/164)) ([e9d143c](https://github.com/Defilan/LLMKube/commit/e9d143c25e61438642ca2a033c3daaaf7e3a93d6))
* **agent:** cache-type-aware memory estimator + TurboQuant docs ([#355](https://github.com/Defilan/LLMKube/issues/355)) ([0697afd](https://github.com/Defilan/LLMKube/commit/0697afdc44939605bb76d0d0a8872c3d326ff934))
* **agent:** eviction safety floor + evictionProtection opt-out + late-spawn condition fix ([#186](https://github.com/Defilan/LLMKube/issues/186)) ([#384](https://github.com/Defilan/LLMKube/issues/384)) ([6544747](https://github.com/Defilan/LLMKube/commit/65447470c1fe4ca5291cb63eead12a3d9533de58))
* **agent:** expose Apple Silicon power gauges via powermetrics ([#334](https://github.com/Defilan/LLMKube/issues/334)) ([58a94a7](https://github.com/Defilan/LLMKube/commit/58a94a7729daf95162e3feca347b86e2119e51b5))
* **agent:** memory-pressure eviction and respawn protection ([#186](https://github.com/Defilan/LLMKube/issues/186)) ([#382](https://github.com/Defilan/LLMKube/issues/382)) ([65a78b5](https://github.com/Defilan/LLMKube/commit/65a78b5409c1a98db8389516a7a8a2be3bc69dc2))
* **agent:** pass Apple Silicon-optimized flags to llama-server ([#327](https://github.com/Defilan/LLMKube/issues/327)) ([a69ab6a](https://github.com/Defilan/LLMKube/commit/a69ab6a32c1039af53a2afcc8a8792e4932753eb))
* **agent:** vllm-swift runtime + TurboQuant passthrough ([#391](https://github.com/Defilan/LLMKube/issues/391)) ([#393](https://github.com/Defilan/LLMKube/issues/393)) ([2691e67](https://github.com/Defilan/LLMKube/commit/2691e67eb855e2af00b2767f046a34c1dfe07db7))
* **api:** add cacheTypeCustomK/V for non-enum llama.cpp KV cache types ([#351](https://github.com/Defilan/LLMKube/issues/351)) ([71bd762](https://github.com/Defilan/LLMKube/commit/71bd7622f983a1ea3a2b9032296346e094b753e1))
* **api:** add kvCacheCustomDtype for non-enum vLLM KV cache types ([#359](https://github.com/Defilan/LLMKube/issues/359)) ([5e796d0](https://github.com/Defilan/LLMKube/commit/5e796d0767e15a300dddd74819765c031aa5d7f4))
* **api:** add podAnnotations and podLabels passthrough (closes [#326](https://github.com/Defilan/LLMKube/issues/326)) ([#381](https://github.com/Defilan/LLMKube/issues/381)) ([baecd68](https://github.com/Defilan/LLMKube/commit/baecd687578f4fe240ce3d4a9d923908161fe10a))
* **api:** expose runtimeClassName on InferenceServiceSpec (closes [#375](https://github.com/Defilan/LLMKube/issues/375)) ([#380](https://github.com/Defilan/LLMKube/issues/380)) ([cc44ff5](https://github.com/Defilan/LLMKube/commit/cc44ff5e14ec0129cee411c5f704b28d15c6d38f))
* auto-detect llama-server from Homebrew paths on macOS ([#215](https://github.com/Defilan/LLMKube/issues/215)) ([a1e4302](https://github.com/Defilan/LLMKube/commit/a1e4302702e6531f2a6cbda9434d9613514cf15a))
* capability-aware scheduler + AgenticTaskWatcher + stub executor (Foreman v0.1 M2) ([#504](https://github.com/Defilan/LLMKube/issues/504)) ([74b3d6e](https://github.com/Defilan/LLMKube/commit/74b3d6e1c47915ff1b7a6ac1025acd035f28cce7))
* **chart:** add values.schema.json for Helm value validation ([#322](https://github.com/Defilan/LLMKube/issues/322)) ([1f8a34d](https://github.com/Defilan/LLMKube/commit/1f8a34d86077d0afb015db3d1567f7bd75f98bda))
* **ci+chart:** make OpenShift a first-class deploy target (closes [#421](https://github.com/Defilan/LLMKube/issues/421)) ([#422](https://github.com/Defilan/LLMKube/issues/422)) ([798a13e](https://github.com/Defilan/LLMKube/commit/798a13e70d1b6a46e8dd08f448654fbed5f49de4))
* **cli:** add comprehensive benchmark test suites and sweeps ([#107](https://github.com/Defilan/LLMKube/issues/107)) ([323a28a](https://github.com/Defilan/LLMKube/commit/323a28ad8c1412fd1a09cd7e18cf7b42d7b55de8))
* **cli:** add stress testing mode to benchmark command ([#104](https://github.com/Defilan/LLMKube/issues/104)) ([530c82e](https://github.com/Defilan/LLMKube/commit/530c82e1f0c62b56a7accae9026ef8a6df7ce1cd))
* configurable proxy + per-route/backend timeouts (closes [#457](https://github.com/Defilan/LLMKube/issues/457), [#458](https://github.com/Defilan/LLMKube/issues/458)) ([#461](https://github.com/Defilan/LLMKube/issues/461)) ([03d222a](https://github.com/Defilan/LLMKube/commit/03d222a759e5d639278ad554425efbd4bc1bac21))
* **controller:** make init container image configurable ([#128](https://github.com/Defilan/LLMKube/issues/128)) ([38ccdf0](https://github.com/Defilan/LLMKube/commit/38ccdf0a1075373ce4b3e40d42ed6fe8e558f1ba))
* **controller:** pin vLLM default image to v0.20.0 ([#362](https://github.com/Defilan/LLMKube/issues/362)) ([d2ae561](https://github.com/Defilan/LLMKube/commit/d2ae561bb4900a52e4e538cd10c19ca848d8e69b))
* **crd:** add gpuMemoryUtilization and cpuOffloadGB to VLLMConfig ([#394](https://github.com/Defilan/LLMKube/issues/394)) ([6883f78](https://github.com/Defilan/LLMKube/commit/6883f784eae6813adb268ddb982b68d99faf45e7))
* **crd:** add ParallelSlots support for vllm and fix llamacpp ([#340](https://github.com/Defilan/LLMKube/issues/340)) ([d81babb](https://github.com/Defilan/LLMKube/commit/d81babbc2b4ffb7437f6111e3b9e5e0c85ec66bc))
* **crd:** extend InferenceService vLLM config for agentic-coding flags ([#306](https://github.com/Defilan/LLMKube/issues/306)) ([cb2aa6a](https://github.com/Defilan/LLMKube/commit/cb2aa6a8c8c921e3db11c71f9309b5b38dafb2df))
* **deps:** upgrade to Kubernetes 1.35 and controller-runtime v0.23.1 ([#175](https://github.com/Defilan/LLMKube/issues/175)) ([3c323f4](https://github.com/Defilan/LLMKube/commit/3c323f46ecfb3ec1b1d4849ce4b9c710d7cc8658))
* expose additional runtime controls for llama.cpp and vllm ([#291](https://github.com/Defilan/LLMKube/issues/291)) ([2245718](https://github.com/Defilan/LLMKube/commit/2245718ae7790f399f96eb66e28717af3d593d97))
* expose llama.cpp parallel slots in InferenceService CRD ([#133](https://github.com/Defilan/LLMKube/issues/133)) ([cae7b52](https://github.com/Defilan/LLMKube/commit/cae7b52d780bff34ce1a6c1cf86165859e171621))
* external provider URL defaults + cluster-wide LiteLLM URL (closes [#438](https://github.com/Defilan/LLMKube/issues/438)) ([#451](https://github.com/Defilan/LLMKube/issues/451)) ([26cd5ae](https://github.com/Defilan/LLMKube/commit/26cd5aebf517b006f9557a84051a13056ed88d82))
* **foreman/api:** structured AgenticTaskFailureReason taxonomy ([#565](https://github.com/Defilan/LLMKube/issues/565)) ([6e72e85](https://github.com/Defilan/LLMKube/commit/6e72e8599a4e6d97e44e026cbc1194df064fc65c))
* **foreman/loop:** observation masking for context-window management ([#563](https://github.com/Defilan/LLMKube/issues/563)) ([d17c3e0](https://github.com/Defilan/LLMKube/commit/d17c3e070416354fdfcc9b39c125f79603abea0d))
* **foreman/loop:** stuck-loop detector with nudge-then-force protocol ([#544](https://github.com/Defilan/LLMKube/issues/544)) ([#569](https://github.com/Defilan/LLMKube/issues/569)) ([2172ece](https://github.com/Defilan/LLMKube/commit/2172ece33486c1a0a0c0b71cd4199b5d1f593854))
* **foreman/m6:** Workload reconciler with stub planner (explicit pipeline + issue-batch shortcut) ([#533](https://github.com/Defilan/LLMKube/issues/533)) ([dbdcd46](https://github.com/Defilan/LLMKube/commit/dbdcd46e5ee1578f6b0be02ac3bf270d3935d7e1))
* **foreman/reviewer:** fetch_issue tool replaces gh issue view subshell ([#581](https://github.com/Defilan/LLMKube/issues/581)) ([0253e43](https://github.com/Defilan/LLMKube/commit/0253e430f02a6d96a8a1ff05597dfb926aa0d411))
* **foreman/tools:** distinguish whitelist-excluded from unknown tool calls ([#564](https://github.com/Defilan/LLMKube/issues/564)) ([089e9ca](https://github.com/Defilan/LLMKube/commit/089e9ca5dd0dcfa9513eda09634f5030d007a707))
* **foreman/v0.2:** hybrid cloud reviewer Agent + sovereignty toggles ([#553](https://github.com/Defilan/LLMKube/issues/553)) ([65a7cb8](https://github.com/Defilan/LLMKube/commit/65a7cb874a492e9eba28888a95c600ebf6789d44))
* **foreman/v0.2:** WorkloadSpec.reviewerAgentRefs (plural) + third pipeline stage ([#551](https://github.com/Defilan/LLMKube/issues/551)) ([831ae8c](https://github.com/Defilan/LLMKube/commit/831ae8c501e6485d234acbd0b1aab2b34af8faf5))
* **foreman:** add repo-map localization for coder Agents ([#560](https://github.com/Defilan/LLMKube/issues/560)) ([#566](https://github.com/Defilan/LLMKube/issues/566)) ([f6bf8c0](https://github.com/Defilan/LLMKube/commit/f6bf8c08db5466bd5ed222c8bc4d009d6ddb1c3a))
* **foreman:** AgenticTask branches include workload name ([#573](https://github.com/Defilan/LLMKube/issues/573)) ([#574](https://github.com/Defilan/LLMKube/issues/574)) ([2986906](https://github.com/Defilan/LLMKube/commit/2986906fc33b09932f03240bf0c1220b499e5a87))
* **foreman:** executor fetches GitHub issue body when payload prompt is empty ([#571](https://github.com/Defilan/LLMKube/issues/571)) ([#572](https://github.com/Defilan/LLMKube/issues/572)) ([2b5bd31](https://github.com/Defilan/LLMKube/commit/2b5bd318ad897c90679f2ac0e378a30e07a8425f))
* **foreman:** gate-role Agent on a verifier node (M4) ([#518](https://github.com/Defilan/LLMKube/issues/518)) ([40a340e](https://github.com/Defilan/LLMKube/commit/40a340e09f3e1845b0ad5bc0b549985fd0d92ab1))
* **foreman:** native agent loop + Agent CRD + coder role on M5 Max (M3) ([#509](https://github.com/Defilan/LLMKube/issues/509)) ([6661343](https://github.com/Defilan/LLMKube/commit/666134373653bc621bf0c411db300f61f83f447b))
* **foreman:** post-M4 stability follow-ups for v5-batch readiness ([#535](https://github.com/Defilan/LLMKube/issues/535)) ([a841612](https://github.com/Defilan/LLMKube/commit/a841612b07bc2cbc57cda2383a1846976bdfff22))
* **foreman:** v0.4 reviewer agent — tool-using reviewer with sharpened prompt + structured findings ([#575](https://github.com/Defilan/LLMKube/issues/575)) ([#576](https://github.com/Defilan/LLMKube/issues/576)) ([06091a9](https://github.com/Defilan/LLMKube/commit/06091a9e78922ee091a8cb9063732b4515626140))
* **foreman:** workspace-scoped bash + WORKSPACE_ROOT contract ([#567](https://github.com/Defilan/LLMKube/issues/567)) ([#568](https://github.com/Defilan/LLMKube/issues/568)) ([061eb41](https://github.com/Defilan/LLMKube/commit/061eb4100d3055d236fe04f42cb079dd08af9631))
* **gguf:** add native Go GGUF parser with CRD integration and CLI inspect ([#140](https://github.com/Defilan/LLMKube/issues/140)) ([9d96ed4](https://github.com/Defilan/LLMKube/commit/9d96ed4b7e0409d14808f536b23f615b7e232004))
* **gpu:** add Intel GPU (oneAPI/SYCL) support across controller, CLI, docs, and e2e ([#557](https://github.com/Defilan/LLMKube/issues/557)) ([741ef5d](https://github.com/Defilan/LLMKube/commit/741ef5db256055a66cda0532c9272f98b96b5568))
* Helm packaging, sample manifest, and concept doc for ModelRouter ([#448](https://github.com/Defilan/LLMKube/issues/448)) ([a513fdc](https://github.com/Defilan/LLMKube/commit/a513fdc44a66c741fd3c5bd4a464e80ebcc91338))
* **helm:** Add image digest support for production deployments ([a38801d](https://github.com/Defilan/LLMKube/commit/a38801dd61d5f6606209577744cc5376bf1eb626))
* **helm:** add optional NetworkPolicy for controller manager ([#135](https://github.com/Defilan/LLMKube/issues/135)) ([8d61ce3](https://github.com/Defilan/LLMKube/commit/8d61ce3811a0d79be136ed078388a39310ad4f3a))
* Implement automatic port forwarding for benchmark command ([472b3ae](https://github.com/Defilan/LLMKube/commit/472b3ae74b73d1d55d5a8a2051625ed1c3834ad9))
* **inference:** add flashAttention and contextSize to sample manifest ([914c929](https://github.com/Defilan/LLMKube/commit/914c929e0ae180bc7c1219582fc97e85398e47fe)), closes [#145](https://github.com/Defilan/LLMKube/issues/145)
* **make:** one-command install-powermetrics-sudo + uninstall targets ([#336](https://github.com/Defilan/LLMKube/issues/336)) ([af48077](https://github.com/Defilan/LLMKube/commit/af4807795c605e97e532e2df38aec9566b8a1d25))
* **metal-agent:** emit Kubernetes events for memory-pressure transitions, evictions, skips, and respawn blocks (closes [#390](https://github.com/Defilan/LLMKube/issues/390)) ([#411](https://github.com/Defilan/LLMKube/issues/411)) ([e0d17d1](https://github.com/Defilan/LLMKube/commit/e0d17d1aa27246db1fda2d8bca4c90686d0fbc72))
* **metal-agent:** InferenceService name allowlist for multi-Mac fleets ([#555](https://github.com/Defilan/LLMKube/issues/555)) ([67361f3](https://github.com/Defilan/LLMKube/commit/67361f385256766969fc65d5994e169609f597d4))
* ModelRouterReconciler skeleton with spec validation ([#445](https://github.com/Defilan/LLMKube/issues/445)) ([9b1a259](https://github.com/Defilan/LLMKube/commit/9b1a2597f6523c87f362c165626ea9a7512f2f15))
* Multi-GPU support with layer-based sharding ([#47](https://github.com/Defilan/LLMKube/issues/47)) ([4797609](https://github.com/Defilan/LLMKube/commit/479760973eb811a0b7a71c711f52ca3d8695b761))
* **observability:** runtime label on inference pods + recording rules + starter dashboard (refs [#409](https://github.com/Defilan/LLMKube/issues/409)) ([#410](https://github.com/Defilan/LLMKube/issues/410)) ([71743ed](https://github.com/Defilan/LLMKube/commit/71743ed7901d8f493a20583dea4c572d8d261304))
* Persistent model cache with per-namespace PVC support ([ab04261](https://github.com/Defilan/LLMKube/commit/ab0426161e3765e539e82ccbf864da943974f199))
* recognize runtime-resolved sources (HF repo IDs) in Model controller ([#293](https://github.com/Defilan/LLMKube/issues/293)) ([953e8a7](https://github.com/Defilan/LLMKube/commit/953e8a7de00836cc82173de4b81e06a406d43772))
* reconcile router-proxy Deployment, Service, and ConfigMap ([#447](https://github.com/Defilan/LLMKube/issues/447)) ([856ecc3](https://github.com/Defilan/LLMKube/commit/856ecc3bae81f3038b287f29f78f51f0096e70e1))
* router-proxy binary with OpenAI streaming passthrough ([#446](https://github.com/Defilan/LLMKube/issues/446)) ([942d09a](https://github.com/Defilan/LLMKube/commit/942d09a6ab931dec8b92875610dc067622c3c5e6))
* router-proxy cluster e2e + runtime fail-closed 503 (closes [#430](https://github.com/Defilan/LLMKube/issues/430)) ([#450](https://github.com/Defilan/LLMKube/issues/450)) ([75151fa](https://github.com/Defilan/LLMKube/commit/75151fa1efcfb1b2e4febc47859245d8eaae033f))
* scaffold Foreman as an opt-in add-on (M0 + M1) ([#501](https://github.com/Defilan/LLMKube/issues/501)) ([cd40491](https://github.com/Defilan/LLMKube/commit/cd404914cc443eab43e16a9dfbf32c47171d2960))
* scaffold ModelRouter CRD types and deepcopy ([#442](https://github.com/Defilan/LLMKube/issues/442)) ([e6c60b3](https://github.com/Defilan/LLMKube/commit/e6c60b34bb0dd5167ff89fb9ae589168b7414d93))
* **security:** supply-chain MVP — checksum install, govulncheck, gosec, codecov ([#310](https://github.com/Defilan/LLMKube/issues/310)) ([f17f59d](https://github.com/Defilan/LLMKube/commit/f17f59d7f3be20d9719591f0d70f9102968e8365))
* separate image registry from repository in Helm chart ([#268](https://github.com/Defilan/LLMKube/issues/268)) ([5c059a4](https://github.com/Defilan/LLMKube/commit/5c059a4f2b26227684c8e148793e259c05e82daa))
* Set up Helm repository on GitHub Pages ([8d62737](https://github.com/Defilan/LLMKube/commit/8d62737931093e429b832f6f862457056fb80cb4))
* Support configurable context size for llama.cpp server ([#73](https://github.com/Defilan/LLMKube/issues/73)) ([6f8e04b](https://github.com/Defilan/LLMKube/commit/6f8e04bc9c420772e65a5dffe1961ae9e92144a4))
* support custom layer splits from GPUShardingSpec ([#267](https://github.com/Defilan/LLMKube/issues/267)) ([a37701c](https://github.com/Defilan/LLMKube/commit/a37701c0bd355b0e209650e8b52a243b61efcdc5))
* Support per-namespace model cache PVCs ([c3cb891](https://github.com/Defilan/LLMKube/commit/c3cb891dc74c3718f495068c98418d84c78b6da9))
* update default CUDA image to server-cuda13 for Qwen3.5 and Blackwell support ([#262](https://github.com/Defilan/LLMKube/issues/262)) ([cc9a95e](https://github.com/Defilan/LLMKube/commit/cc9a95eadd5077c6234f2cbf0518a804a303269a))
* update model catalog with DeepSeek R1 and refresh stale entries ([#131](https://github.com/Defilan/LLMKube/issues/131)) ([89eb5a6](https://github.com/Defilan/LLMKube/commit/89eb5a6e99b27f8dbc4847727bc0d72834919a70))


### Bug Fixes

* Add cacheKey to CRD and restrict cache to llmkube-system namespace ([464c23d](https://github.com/Defilan/LLMKube/commit/464c23d07bffebcab8cda58d8ce8d00ad8d4ecba))
* Add CRD keep policy and improve security test reliability ([ff32296](https://github.com/Defilan/LLMKube/commit/ff32296a45174bdce6070844a68007e2c45cf3fe))
* Add Helm chart publishing to release workflow ([8baf9c4](https://github.com/Defilan/LLMKube/commit/8baf9c4b09ea27f8b229adb499582f83eff2e5be))
* Add Helm chart publishing to release workflow ([03bab72](https://github.com/Defilan/LLMKube/commit/03bab72a74496085b79e3c51838f9853ed674062))
* Add Homebrew archive IDs and v0.3.0 release notes ([cea933b](https://github.com/Defilan/LLMKube/commit/cea933beac2607122772d14184b35da04738b7f9))
* Address lint issues in benchmark command ([bf80610](https://github.com/Defilan/LLMKube/commit/bf806107c664425d9f8a4a3056600ba6ec95b34e))
* Address linter errors in catalog implementation ([8932e4f](https://github.com/Defilan/LLMKube/commit/8932e4fbb3fe8d1fea1fedba5bb18f3cd02808c8))
* Address linter issues in Metal agent code ([3f1f678](https://github.com/Defilan/LLMKube/commit/3f1f678502c985b04d48a1c8c8bc44ea68d8a542))
* **agent:** detect stalled K8s polling and exit for supervisor restart ([#328](https://github.com/Defilan/LLMKube/issues/328)) ([c0636cc](https://github.com/Defilan/LLMKube/commit/c0636cc7ede733f43c6d38c99c615fe4c1d73659))
* **agent:** filter InferenceServices by Metal accelerator type ([#157](https://github.com/Defilan/LLMKube/issues/157)) ([5737bb7](https://github.com/Defilan/LLMKube/commit/5737bb7c1cc9510507f9fda91519ecbfd1ab3271))
* **agent:** let the kernel pick free ports for llama-server ([#321](https://github.com/Defilan/LLMKube/issues/321)) ([8111395](https://github.com/Defilan/LLMKube/commit/8111395c60f8f005082ace9efd7eb57b7f2b92d6))
* **agent:** make executor startup timeouts configurable; raise defaults to 120s ([#330](https://github.com/Defilan/LLMKube/issues/330)) ([5aa5fa2](https://github.com/Defilan/LLMKube/commit/5aa5fa2f5063bd14ff4396efec6ce93005dd8f5d))
* **agent:** read contextSize from InferenceService CRD ([#160](https://github.com/Defilan/LLMKube/issues/160)) ([17f58d4](https://github.com/Defilan/LLMKube/commit/17f58d40c20c83d1cbb1d19e2ec473c18af7b218))
* **agent:** reconcile orphaned Service+Endpoints on agent startup ([#332](https://github.com/Defilan/LLMKube/issues/332)) ([d88c541](https://github.com/Defilan/LLMKube/commit/d88c541e28badb179723dcb2c907646d2e833c49))
* **agent:** respawn on InferenceService spec drift, honor replicas=0, and plumb full spec to llama-server flags ([#353](https://github.com/Defilan/LLMKube/issues/353)) ([ff54cad](https://github.com/Defilan/LLMKube/commit/ff54cad355096ce34d70aebf4fe114ab32745348))
* **agent:** unregister service endpoints on metal process delete ([#168](https://github.com/Defilan/LLMKube/issues/168)) ([147b9bc](https://github.com/Defilan/LLMKube/commit/147b9bcb7a8ece1ecb2a91c62a249c591f9c9a07))
* bump InferenceService spec.contextSize cap from 131072 to 2097152 ([#300](https://github.com/Defilan/LLMKube/issues/300)) ([a46a1bf](https://github.com/Defilan/LLMKube/commit/a46a1bf31ba222f66a7474d580500fe029640294))
* **catalog:** default phi-4-mini context to 8K (closes [#386](https://github.com/Defilan/LLMKube/issues/386)) ([#387](https://github.com/Defilan/LLMKube/issues/387)) ([7bcd685](https://github.com/Defilan/LLMKube/commit/7bcd6856837784c13f2534493ed059316f188db4))
* **chart:** sync Helm CRDs from kubebuilder source and add CI guard ([#367](https://github.com/Defilan/LLMKube/issues/367)) ([73bd2b4](https://github.com/Defilan/LLMKube/commit/73bd2b40367a88c3f345fbcaf5872039505846d3))
* **ci:** use go-version-file in release workflows ([3b14fc8](https://github.com/Defilan/LLMKube/commit/3b14fc87f26b2c5933ac11d997186b269a1f42f5))
* Clean up release process - single release with proper notes ([#66](https://github.com/Defilan/LLMKube/issues/66)) ([4deae85](https://github.com/Defilan/LLMKube/commit/4deae853cacc3aae86b5782c3e2ee79e18011f7e))
* clear stale conditions when a model reaches Ready without a download ([#476](https://github.com/Defilan/LLMKube/issues/476)) ([06325b0](https://github.com/Defilan/LLMKube/commit/06325b0d72559b40625ef045840284903c897fac))
* **cli:** use numeric comparison for version checking ([#109](https://github.com/Defilan/LLMKube/issues/109)) ([05e0025](https://github.com/Defilan/LLMKube/commit/05e00250b9be4e115e7be78bef84e08bd2d1d1b4))
* close cloud-tier conns + drop local idle timeout (closes [#459](https://github.com/Defilan/LLMKube/issues/459)) ([#460](https://github.com/Defilan/LLMKube/issues/460)) ([173c26a](https://github.com/Defilan/LLMKube/commit/173c26a1c5663a0e8b4545a5a8cba7150e28e16e))
* controller metrics port declarations and ServiceMonitor consistency ([#214](https://github.com/Defilan/LLMKube/issues/214)) ([296ec99](https://github.com/Defilan/LLMKube/commit/296ec990c17484a823a6b4261ce409b894535e02))
* **controller:** Add Model watch to InferenceService controller ([cb4e201](https://github.com/Defilan/LLMKube/commit/cb4e2019583a811fa98af1a446bd0df6b6c3cba2))
* **controller:** default FSGroup to curl_group + Longhorn-backed e2e job (closes [#418](https://github.com/Defilan/LLMKube/issues/418), closes [#420](https://github.com/Defilan/LLMKube/issues/420)) ([adce90f](https://github.com/Defilan/LLMKube/commit/adce90fd46be37aa8ad6be566012b7c7dbd6d016))
* **controller:** defer HTTP(S) Model downloads to the workload init container ([#364](https://github.com/Defilan/LLMKube/issues/364)) ([469f542](https://github.com/Defilan/LLMKube/commit/469f5428d16a01a6f8f0797976f70e2f8ecba62b))
* **controller:** drop model label from Deployment selector to make modelRef mutable (closes [#301](https://github.com/Defilan/LLMKube/issues/301)) ([#385](https://github.com/Defilan/LLMKube/issues/385)) ([a1de3bf](https://github.com/Defilan/LLMKube/commit/a1de3bf7801748666a0089bd44dbdc094a7e5244))
* **controller:** stop hot-spinning on unreachable file:// model sources (closes [#405](https://github.com/Defilan/LLMKube/issues/405)) ([#412](https://github.com/Defilan/LLMKube/issues/412)) ([4ac6f57](https://github.com/Defilan/LLMKube/commit/4ac6f573910ea1f08aa41db2c3dbb374431a5490))
* **controller:** use fully qualified image names for curl ([#121](https://github.com/Defilan/LLMKube/issues/121)) ([213660b](https://github.com/Defilan/LLMKube/commit/213660b031c6ea19d9abe5eeaab5de3abb5aebc8))
* **controller:** use GGUF metadata name for downloaded model file basename ([#347](https://github.com/Defilan/LLMKube/issues/347)) ([e932c7a](https://github.com/Defilan/LLMKube/commit/e932c7ae1c484fab9f99202d9ea35a7c8abb3906))
* correct CHANGELOG entry from 0.4.21 to 0.5.0 ([#212](https://github.com/Defilan/LLMKube/issues/212)) ([f7f703a](https://github.com/Defilan/LLMKube/commit/f7f703ad32404a2a38aeab428ed76c37b0a8fcf8))
* Correct CLI binary path in E2E tests ([41af555](https://github.com/Defilan/LLMKube/commit/41af55589ba6b17f07119b50d96db9c39eac6ea3))
* correct Metal quickstart docs for selectorless services ([#173](https://github.com/Defilan/LLMKube/issues/173)) ([89471ec](https://github.com/Defilan/LLMKube/commit/89471ec7f5569ca0192fb76c15bd408aa2986c1b))
* derive metal InferenceService phase from Endpoints, not desiredReplicas (closes [#374](https://github.com/Defilan/LLMKube/issues/374)) ([#376](https://github.com/Defilan/LLMKube/issues/376)) ([350dafe](https://github.com/Defilan/LLMKube/commit/350dafe281d843527a53a10f4013a67b60d306cf))
* Don't mark Helm chart release as latest ([#70](https://github.com/Defilan/LLMKube/issues/70)) ([761b154](https://github.com/Defilan/LLMKube/commit/761b154a7f51fa38727c70f82dd8020b59807289))
* don't quarantine backends on per-attempt context deadline (closes [#462](https://github.com/Defilan/LLMKube/issues/462)) ([#463](https://github.com/Defilan/LLMKube/issues/463)) ([80ef9c8](https://github.com/Defilan/LLMKube/commit/80ef9c81862ffb5e9e61594fffd12ee374f0d36a))
* **e2e:** unblock MicroShift SCC diagnostics + bump bootstrap timeout ([#466](https://github.com/Defilan/LLMKube/issues/466)) ([0c793b7](https://github.com/Defilan/LLMKube/commit/0c793b74b70a6f7baf1891f8e62cbbb59c3ff933))
* enable controller metrics endpoint in Helm chart ([#195](https://github.com/Defilan/LLMKube/issues/195)) ([70940af](https://github.com/Defilan/LLMKube/commit/70940afc948dae5a1a6d1fc6d4e330908ec973dc))
* Fix GoReleaser Homebrew tap configuration for v0.3.0 ([4e95c04](https://github.com/Defilan/LLMKube/commit/4e95c04718b83acf59fb4401bbb9c897e34b4a5c))
* **foreman/build:** include gate_job_template.yaml in Docker context ([#554](https://github.com/Defilan/LLMKube/issues/554)) ([def535d](https://github.com/Defilan/LLMKube/commit/def535d3da8e28fa6d9eeba798d1885a182d176c))
* **foreman/executor:** resolve InferenceService port from live Endpoints, not stale install-time override ([#550](https://github.com/Defilan/LLMKube/issues/550)) ([4351608](https://github.com/Defilan/LLMKube/commit/43516088c7cd3af704e51e411b9e3bd657fd307c))
* **foreman/executor:** route reviewer-role GO through modelDecidedResult ([#545](https://github.com/Defilan/LLMKube/issues/545)) ([16943a5](https://github.com/Defilan/LLMKube/commit/16943a5814eeeb7bac897b2e816cea51f4004bc2))
* **foreman/loop:** force-terminate returns clean Terminal envelope ([#544](https://github.com/Defilan/LLMKube/issues/544) follow-up) ([#570](https://github.com/Defilan/LLMKube/issues/570)) ([19500c9](https://github.com/Defilan/LLMKube/commit/19500c9a36fb87d390eab93204ca6a69499705a6))
* **foreman/m4:** gate Job honors payload.branch + clones from --git-remote-url ([#529](https://github.com/Defilan/LLMKube/issues/529)) ([905a269](https://github.com/Defilan/LLMKube/commit/905a2698a922641a8cd64ce6bd81e18ff7ecb339))
* **foreman/oai:** always emit content on non-assistant messages ([#562](https://github.com/Defilan/LLMKube/issues/562)) ([f6dc8e1](https://github.com/Defilan/LLMKube/commit/f6dc8e16f734808baa441540fa5e26f402c947bf))
* **foreman/reviewer:** ground-truth filesTouched + bump qwen maxTurns + tighten confabulation defenses ([#584](https://github.com/Defilan/LLMKube/issues/584)) ([b3e21f0](https://github.com/Defilan/LLMKube/commit/b3e21f096fd61be674dc10b7843a56898a6e094a))
* **foreman/reviewer:** ground-truth issueAsk + cap qwen Section D ([#587](https://github.com/Defilan/LLMKube/issues/587)) ([b66006c](https://github.com/Defilan/LLMKube/commit/b66006c8234b867fa60edbea0cc75004abcf00eb))
* **foreman/reviewer:** role-aware stuck-loop detector + non-empty reviewer user prompt (rerun-7 follow-up) ([#577](https://github.com/Defilan/LLMKube/issues/577)) ([19590f6](https://github.com/Defilan/LLMKube/commit/19590f64c08522fb1d924e23cb934fd47e376783))
* **foreman/tools:** cmd.WaitDelay + process-group kill so BashTool can't deadlock on grandchild-held pipes ([#547](https://github.com/Defilan/LLMKube/issues/547)) ([c12f6f8](https://github.com/Defilan/LLMKube/commit/c12f6f82674f5167fbc6022315c4b2530d3c7106))
* **foreman:** cascade + Workload rollup gate on phase AND verdict, not phase alone ([#548](https://github.com/Defilan/LLMKube/issues/548)) ([1b72a7c](https://github.com/Defilan/LLMKube/commit/1b72a7c9d4d5545eab74a2a15b2422335cd9ead4))
* **foreman:** chart wires --workspace-dir + tightens docs for native-mode required values ([#534](https://github.com/Defilan/LLMKube/issues/534)) ([1c43c69](https://github.com/Defilan/LLMKube/commit/1c43c69fa257ae1d2cb8aecada54831e815e2780))
* **foreman:** drop chart-level subchart dep on llmkube (unblock v0.7.11 chart-releaser) ([#519](https://github.com/Defilan/LLMKube/issues/519)) ([207ddc6](https://github.com/Defilan/LLMKube/commit/207ddc64f82e0243da96bdd73e1b5d949f991041))
* Further increase Helm CI timeout and readiness probe delay ([5453d66](https://github.com/Defilan/LLMKube/commit/5453d66a21be60af17528724c4c760b7524c358f))
* Further increase Helm CI timeout and readiness probe delay ([fd577d3](https://github.com/Defilan/LLMKube/commit/fd577d3137da086346524f1802e47219feefa1fa))
* half-open circuit breaker on proxy + scale-to-zero status (closes [#452](https://github.com/Defilan/LLMKube/issues/452), [#453](https://github.com/Defilan/LLMKube/issues/453)) ([#454](https://github.com/Defilan/LLMKube/issues/454)) ([ac9302c](https://github.com/Defilan/LLMKube/commit/ac9302cb1b5ce90201276458aaf57b85b50cca2f))
* Handle resp.Body.Close error in version check (linter) ([fb3adf5](https://github.com/Defilan/LLMKube/commit/fb3adf57913744e08ebffb58af6877bd15fbeb93))
* improve Metal agent usability ([#254](https://github.com/Defilan/LLMKube/issues/254)) ([149c582](https://github.com/Defilan/LLMKube/commit/149c582305b32b9bd51f498d7e2a85aa0dead223))
* Increase Helm chart CI timeout from 2m to 5m ([7a08b45](https://github.com/Defilan/LLMKube/commit/7a08b45a3f96fa85ec71f609d8c035c4a3e91db9))
* Increase Helm chart CI timeout from 2m to 5m ([ced2210](https://github.com/Defilan/LLMKube/commit/ced2210ea28d453fdac4c7346bc98f66684893b1))
* inference PodMonitor selector matched no pods ([#481](https://github.com/Defilan/LLMKube/issues/481)) ([31ee4d6](https://github.com/Defilan/LLMKube/commit/31ee4d675016014306e7634935c04790dcfbd052))
* **inference:** pass value to --flash-attn for newer llama.cpp versions ([#148](https://github.com/Defilan/LLMKube/issues/148)) ([25e08d0](https://github.com/Defilan/LLMKube/commit/25e08d0270241d15c0a1815c11e12627cfe5eb27))
* InferenceService stuck in Pending when Model becomes Ready ([4d20aec](https://github.com/Defilan/LLMKube/commit/4d20aec51760ed5fa6946a1be57045eee4b84593))
* inherit runAsUser/runAsGroup from podSecurityContext  ([#274](https://github.com/Defilan/LLMKube/issues/274)) ([72b9b5c](https://github.com/Defilan/LLMKube/commit/72b9b5cb6260e918bc56bef0c0bf137d69216b85))
* mark Metal local-path models Ready instead of stuck Copying ([#472](https://github.com/Defilan/LLMKube/issues/472)) ([c513c84](https://github.com/Defilan/LLMKube/commit/c513c84bd2a19253230b56e8d5bb11cca3778edd))
* Metal agent production fixes and testing improvements ([8744c7b](https://github.com/Defilan/LLMKube/commit/8744c7b54e23cbb77609a97340d9be9dd5da931c))
* metal-path InferenceService status and memory pre-flight ([#488](https://github.com/Defilan/LLMKube/issues/488)) ([98ef2c4](https://github.com/Defilan/LLMKube/commit/98ef2c4fb42e0d4aa248a8c77f6c09ae8c1058ac))
* point metal-agent mlx-server install hint at the Homebrew formula ([#477](https://github.com/Defilan/LLMKube/issues/477)) ([74b3333](https://github.com/Defilan/LLMKube/commit/74b33337f4abb5b54a1f1d9be216a4d5fc2e2c82))
* preserve external annotations on reconciler Deployment updates ([#468](https://github.com/Defilan/LLMKube/issues/468)) ([de580c1](https://github.com/Defilan/LLMKube/commit/de580c18f60e2239ee16027d77759ff7c729325d))
* prevent command injection in init container shell commands ([#172](https://github.com/Defilan/LLMKube/issues/172)) ([3aa9cc3](https://github.com/Defilan/LLMKube/commit/3aa9cc30fce879f49ff42389fda5633c00d6396a))
* prevent concurrent runtime respawn in metal-agent ([#469](https://github.com/Defilan/LLMKube/issues/469)) ([f34640b](https://github.com/Defilan/LLMKube/commit/f34640b118e4a043888e2eb8bb20012c6f2d5b42))
* prevent model re-download of cached models after helm upgrade ([#203](https://github.com/Defilan/LLMKube/issues/203)) ([a8f9a88](https://github.com/Defilan/LLMKube/commit/a8f9a886f0e9d081505183f1d30d2a37ee050068))
* quote job-level if expression to fix YAML parsing in helm-chart workflow ([8714b9f](https://github.com/Defilan/LLMKube/commit/8714b9fc60d7020be4c21d5764ced7b88bd7f97a))
* remove mutable latest tags and pin container images ([#174](https://github.com/Defilan/LLMKube/issues/174)) ([3c4569a](https://github.com/Defilan/LLMKube/commit/3c4569aafdb73127eeee2260e8d722459a91823a))
* report Stopped phase when InferenceService.spec.replicas=0 on Metal path ([#498](https://github.com/Defilan/LLMKube/issues/498)) ([7787239](https://github.com/Defilan/LLMKube/commit/77872395deda1ec5ce89d61c12de62cedd998968))
* Resolve Helm chart CI test failures ([9919696](https://github.com/Defilan/LLMKube/commit/99196961bf91e4c285182211a7a6fdec574ae7e7))
* Resolve staticcheck SA5011 lint errors and update CONTRIBUTING.md ([#60](https://github.com/Defilan/LLMKube/issues/60)) ([c0b5824](https://github.com/Defilan/LLMKube/commit/c0b5824fa3c42a547c1c760c7dbb5dd68bd4e89f))
* Sanitize Service names for DNS-1035 compliance (v0.3.3) ([db81990](https://github.com/Defilan/LLMKube/commit/db819902a121628c196899b9b449eeccf3be9394))
* Sanitize Service names to comply with DNS-1035 requirements ([b431986](https://github.com/Defilan/LLMKube/commit/b431986ceae6b383ee064bec595c922a42394a8e))
* Set empty component to prevent llmkube- prefix in releases ([#68](https://github.com/Defilan/LLMKube/issues/68)) ([45b61c6](https://github.com/Defilan/LLMKube/commit/45b61c680e4880040f9cab36fbf28cb931686462))
* Skip containerized Deployment for Metal accelerator and add version check ([d300e64](https://github.com/Defilan/LLMKube/commit/d300e64efb57a10917018c000d9d855d51d9dcc6))
* Skip containerized Deployment for Metal accelerator and add version check ([8dab955](https://github.com/Defilan/LLMKube/commit/8dab955a2d1e728fe8a9b1b2971a4906454d71c3))
* stop the operator fighting the HPA over Deployment replicas ([#485](https://github.com/Defilan/LLMKube/issues/485)) ([8fc70e2](https://github.com/Defilan/LLMKube/commit/8fc70e23cb6a8b699c7d853cf109d1e55561d6eb))
* Suppress Endpoints API deprecation warnings ([e70a4b3](https://github.com/Defilan/LLMKube/commit/e70a4b391725a70a82d78d47a7d4f6d2b898dcc8))
* Trigger GoReleaser and Helm release from Release Please workflow ([#64](https://github.com/Defilan/LLMKube/issues/64)) ([9a37a77](https://github.com/Defilan/LLMKube/commit/9a37a77e556d6f811cb6a090125a4a73e2e9c346))
* Update operator deployment to use correct container image ([00fee75](https://github.com/Defilan/LLMKube/commit/00fee7580b3661259e8c09491739a86f685da6e9))
* Update operator deployment to use correct container image ([4c67a78](https://github.com/Defilan/LLMKube/commit/4c67a7806232c687b7b2450660735d9265d507b8))
* Update version.go to 0.2.1 and add automation for future releases ([8dd613d](https://github.com/Defilan/LLMKube/commit/8dd613d7de88f93e150930ea11f6aad3760b792a))
* Update version.go to 0.2.1 and add automation for future releases ([2ff68bd](https://github.com/Defilan/LLMKube/commit/2ff68bdc0e40ab9ee8337403af649fda7354ad7c))
* use Recreate strategy for GPU workloads to prevent rolling update deadlock ([#196](https://github.com/Defilan/LLMKube/issues/196)) ([2e45181](https://github.com/Defilan/LLMKube/commit/2e4518106cd9306b4d2a472fc9c9432d015a69c9))
* Use simple v* tag format for releases ([#62](https://github.com/Defilan/LLMKube/issues/62)) ([bda9f19](https://github.com/Defilan/LLMKube/commit/bda9f19157e8ececd995e7488b751fdeb53cf144))
* Use workspace path for kubeconform validation ([fc066d8](https://github.com/Defilan/LLMKube/commit/fc066d8d0f9175382fa7cfab5f40c755739e175f))
* **vllm:** set enableServiceLinks=false on vLLM Pod spec ([#361](https://github.com/Defilan/LLMKube/issues/361)) ([01eb5c5](https://github.com/Defilan/LLMKube/commit/01eb5c5bcaf6740bc4054c5185cbcbdd17d2685f))
* **vllm:** use positional model argument instead of deprecated --model ([#360](https://github.com/Defilan/LLMKube/issues/360)) ([a17566c](https://github.com/Defilan/LLMKube/commit/a17566cc5211c2f2dea1a22dbe40c74031c486fa))


### Documentation

* add ADOPTERS.md inviting public user listings ([#324](https://github.com/Defilan/LLMKube/issues/324)) ([871a0cb](https://github.com/Defilan/LLMKube/commit/871a0cb8b5eba4e1fb918dfab2c2d67938ad73c7))
* add AGENTS.md ([#496](https://github.com/Defilan/LLMKube/issues/496)) ([89d3766](https://github.com/Defilan/LLMKube/commit/89d3766ba5a43726fdf89b0fbe61caf7bacb75dc))
* add Apple Silicon Metal option to bug report template ([#169](https://github.com/Defilan/LLMKube/issues/169)) ([e7689d8](https://github.com/Defilan/LLMKube/commit/e7689d868f2034f4e60d37a813cb4c72bf2b3f37))
* Add CLI option to quick start, keep kubectl as fallback ([f6829ee](https://github.com/Defilan/LLMKube/commit/f6829ee44a33e114921fbc60557f1268e144e22d))
* add CNCF/Kubernetes trademark disclaimer ([#246](https://github.com/Defilan/LLMKube/issues/246)) ([27a49eb](https://github.com/Defilan/LLMKube/commit/27a49eb46e37d53c028a53e46526ef9f408c9b7e))
* add community standards and security policy ([#92](https://github.com/Defilan/LLMKube/issues/92)) ([e7c9cad](https://github.com/Defilan/LLMKube/commit/e7c9cad0887cbe43bcc72c01500919b9268009a2))
* add consumer-hardware model matrix guide ([#444](https://github.com/Defilan/LLMKube/issues/444)) ([dd07397](https://github.com/Defilan/LLMKube/commit/dd07397de39efd549581b5253ab2767bc442ba6c))
* add Discord community link ([#236](https://github.com/Defilan/LLMKube/issues/236)) ([c0d499d](https://github.com/Defilan/LLMKube/commit/c0d499d0bf5cbac220851ec5da81a04d466d2bdc))
* add getting started video to README ([#76](https://github.com/Defilan/LLMKube/issues/76)) ([ceb83d7](https://github.com/Defilan/LLMKube/commit/ceb83d79d4338eafcedb6cce583321bb6100bc7e))
* add MAINTAINERS file and recommend private vulnerability reporting ([#479](https://github.com/Defilan/LLMKube/issues/479)) ([aaccb4d](https://github.com/Defilan/LLMKube/commit/aaccb4dea54b5cb52304b303b823a3531dfe5a4c))
* Add Metal Agent (Apple Silicon) support to README ([#151](https://github.com/Defilan/LLMKube/issues/151)) ([3579426](https://github.com/Defilan/LLMKube/commit/3579426ea24616f75104233f90fdb0b90b933070))
* add NVIDIA Blackwell B200 (sm_100) validation matrix (refs [#413](https://github.com/Defilan/LLMKube/issues/413)) ([#414](https://github.com/Defilan/LLMKube/issues/414)) ([bfda149](https://github.com/Defilan/LLMKube/commit/bfda149844c006d66acb5dcfc7c95909e2dfba8d))
* add OpenShift troubleshooting to README ([#241](https://github.com/Defilan/LLMKube/issues/241)) ([47fd1b0](https://github.com/Defilan/LLMKube/commit/47fd1b039e64192e459ba50fc76f4d05293eabd8))
* Add release notes for v0.3.2 ([177abf8](https://github.com/Defilan/LLMKube/commit/177abf812f220cd4a4b203a978a71c997bfdb5b6))
* Add release notes for v0.3.2 ([ca1bb12](https://github.com/Defilan/LLMKube/commit/ca1bb12f0e99392e91fb99a9e946138d8d466674))
* Add release notes for v0.4.0 ([144b960](https://github.com/Defilan/LLMKube/commit/144b9603fd6f96ef65d7ff83a2e72dc6c186a7ae))
* Add release notes for v0.4.0 ([a61321f](https://github.com/Defilan/LLMKube/commit/a61321f74add8fba1651b25b134e77468f8e8d43))
* backfill ⚠ BREAKING CHANGES section into 0.7.0 changelog ([#296](https://github.com/Defilan/LLMKube/issues/296)) ([2ad4640](https://github.com/Defilan/LLMKube/commit/2ad4640c56b7592a5b3e7f337ec72444389012c9))
* bump broken bartowski phi-4-mini URL to renamed repo ([#514](https://github.com/Defilan/LLMKube/issues/514)) ([9f15d98](https://github.com/Defilan/LLMKube/commit/9f15d9891ddc32e118f55b378f8e357e2e7e4d14))
* fix broken phi-3-mini command and dead benchmark link ([#369](https://github.com/Defilan/LLMKube/issues/369)) ([6a1fd58](https://github.com/Defilan/LLMKube/commit/6a1fd58b62966c3ee7c310c10859978bc75bf2df))
* HN launch prep README polish (llama.cpp credit, vLLM, KubeAI/llm-d) ([#371](https://github.com/Defilan/LLMKube/issues/371)) ([9d27774](https://github.com/Defilan/LLMKube/commit/9d277744d5fd3a59ea55888299f5c715e8e53523))
* **macos-metal:** derive curl port from Endpoints (follow-up to [#513](https://github.com/Defilan/LLMKube/issues/513)) ([#515](https://github.com/Defilan/LLMKube/issues/515)) ([83085c2](https://github.com/Defilan/LLMKube/commit/83085c218ff17c2e0a995110b090aca75aa9e99f))
* **macos-metal:** replace broken port-forward step with host-localhost curl ([#513](https://github.com/Defilan/LLMKube/issues/513)) ([0f7f7a7](https://github.com/Defilan/LLMKube/commit/0f7f7a7c903660272b53d52c6f5de18838237b5e))
* **operations:** seed runbooks index + first 2 entries (file:// hot-spin, metal-agent memory pressure) ([#417](https://github.com/Defilan/LLMKube/issues/417)) ([d3bce8d](https://github.com/Defilan/LLMKube/commit/d3bce8d7f1d481a5792135f5e46ffd5f77102334))
* Overhaul README and roadmap for public launch ([b42c17e](https://github.com/Defilan/LLMKube/commit/b42c17e1fd796b15976ea81d700f751da85041dc))
* port concepts/comparison to markdown (first Phase 1C content port) ([#403](https://github.com/Defilan/LLMKube/issues/403)) ([51c396b](https://github.com/Defilan/LLMKube/commit/51c396b9b0b66d2cabf985da4a3533347aefee76))
* **readme:** HN-launch readiness fixes (broken link, Apple Silicon CTA, quickstart memory) ([#401](https://github.com/Defilan/LLMKube/issues/401)) ([3e44bfb](https://github.com/Defilan/LLMKube/commit/3e44bfb8bcfb21ce950c3305b2ebca653645e191))
* **readme:** land ModelRouter prominently for the 0.7.8 release ([#464](https://github.com/Defilan/LLMKube/issues/464)) ([deb24bb](https://github.com/Defilan/LLMKube/commit/deb24bb572d85d40422e26c764a57f195642677a))
* refresh quickstart cast for v0.7.6 (HN launch) ([#404](https://github.com/Defilan/LLMKube/issues/404)) ([5abaddb](https://github.com/Defilan/LLMKube/commit/5abaddb99b994b393ac3201de4d363aba4d0f231))
* rewrite README for clarity, positioning, and growth ([#190](https://github.com/Defilan/LLMKube/issues/190)) ([a7fc152](https://github.com/Defilan/LLMKube/commit/a7fc15238fe5c3dfe698aa6acb05234fe8b51adc))
* **site:** air-gapped, OpenShift, macOS Metal guides + architecture refresh (Tier 1) ([#465](https://github.com/Defilan/LLMKube/issues/465)) ([5996a1e](https://github.com/Defilan/LLMKube/commit/5996a1e707df399070dcc67b3a6100b7c30cd8e5))
* **site:** drop stale "fifteen lines" claim in openshift-install Reference ([#467](https://github.com/Defilan/LLMKube/issues/467)) ([ec52ca8](https://github.com/Defilan/LLMKube/commit/ec52ca87da0644b839cb37d7a3db9cfbd1e5e4ac))
* split docs/ into site/ and contributors/, prep for site rendering ([#396](https://github.com/Defilan/LLMKube/issues/396)) ([9299a31](https://github.com/Defilan/LLMKube/commit/9299a3168fef2f2afd1329a026f39486da42b8e6))
* surface breaking behavior changes for 0.7.0 ([#294](https://github.com/Defilan/LLMKube/issues/294)) ([e234a40](https://github.com/Defilan/LLMKube/commit/e234a400ca3a20cf43d6d29dbb9f7e361b577a00))
* Update binary download links to version 0.2.1 ([fad530a](https://github.com/Defilan/LLMKube/commit/fad530a58384787d480146bdac27f26256a04d82))
* Update binary download links to version 0.2.1 ([63bb0fa](https://github.com/Defilan/LLMKube/commit/63bb0fa1937afe0ff7fc0fe1c569b64459d360b7))
* update documentation for v0.4.9 GPU scheduling features ([#83](https://github.com/Defilan/LLMKube/issues/83)) ([0934e8f](https://github.com/Defilan/LLMKube/commit/0934e8f605b3d65eee74fd2e62e8eeb3132f4518))
* Update Helm installation to use GitHub Pages repository ([477e037](https://github.com/Defilan/LLMKube/commit/477e037a41dca72347b98a3ed1995dbebb30189c))
* Update MODEL-CACHE.md for per-namespace PVC pattern ([0be3f46](https://github.com/Defilan/LLMKube/commit/0be3f4697fd249aba4e9120de93fe0d5942a3f90))
* update README and Metal Agent guide for remote K8s architecture ([#156](https://github.com/Defilan/LLMKube/issues/156)) ([79145b2](https://github.com/Defilan/LLMKube/commit/79145b2b2b59137d7792e0d1c3c36c1b78b9b460))
* **upgrade:** OpenShift / OKD / MicroShift installs must use `helm ... -f charts/llmkube/values-openshift.yaml` so restricted-v2 SCC can inject fsGroup from the namespace's allocated range ([adce90f](https://github.com/Defilan/LLMKube/commit/adce90fd46be37aa8ad6be566012b7c7dbd6d016))
* **upgrade:** operators using a custom `--init-container-image` whose user is not curl (uid=101 gid=102) should set `spec.podSecurityContext` on each InferenceService or pass `--default-fsgroup=<gid>` to the controller ([adce90f](https://github.com/Defilan/LLMKube/commit/adce90fd46be37aa8ad6be566012b7c7dbd6d016))
* **upgrade:** v0.7.7 rolls every InferenceService Pod once on first reconcile (Deployment template gains fsGroup=102 and the new `inference.llmkube.dev/runtime` label) ([adce90f](https://github.com/Defilan/LLMKube/commit/adce90fd46be37aa8ad6be566012b7c7dbd6d016))
