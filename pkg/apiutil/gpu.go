...
// controller package (and any other consumer) can reference the same
// constants the apiutil mapping uses, instead of redeclaring them and
// silently drifting. See issue #1255.
const (
